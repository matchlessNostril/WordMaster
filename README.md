...
単語を覚えるとき、発音も一緒に覚えなければならないことってありませんか？

また、これまで覚えた単語をすべて含めて、繰り返しやランダムでテストするのが不便だと感じたことはないでしょうか？

**WordMaster**を使えば、フォルダ構造で自由に単語帳を作成して、

好きな単語帳を選んでテストを作成し、繰り返し・ランダムテストができます。

単語を完璧に覚えるためのサポートが整っています！
